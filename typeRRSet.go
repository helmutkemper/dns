...
// RRSet is a set of resource records indexed by record name and record type.
// RRSet is a thread type safe, preventing more than one operation from being made per time on map type
type RRSet struct {
	l    sync.Mutex
